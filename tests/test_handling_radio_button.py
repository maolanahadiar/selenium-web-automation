...
from data.data_testing import RADIO_DATA
...
def test_handling_radio_button(browser):
    ...
    assert page.get_page_title_of_radio() == RADIO_DATA["title_page"]
    
    #Select radio button of "Yes" and verify the result
    page.click_radio_button_of_yes()
    assert page.get_actual_result() == RADIO_DATA["expected_result_of_yes"]
    
    #Select radio button of "Impressive" and verify the result
    page.click_radio_button_of_impressive()
    assert page.get_actual_result() == RADIO_DATA["expected_result_of_impressive"]
